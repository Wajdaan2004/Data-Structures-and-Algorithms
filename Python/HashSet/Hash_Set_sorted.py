...
from List.List_array import List
...
class Hash_Set:
    ...
    def _rehash(self):
        ...
        while len(temporary_table) > 0:
            previous_slot = temporary_table.pop(0)
            while not previous_slot.is_empty():
                val = previous_slot.remove_front()
    ...
    def debug(self):
        ...
        #     print("Slot {}: {}".format(i, self.table[i]))
        # for i in range(len(self.table)):
