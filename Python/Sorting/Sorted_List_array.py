...
class Sorted_List:
    ...
    def __getitem__(self, i):
        """
        ---------------------------------------------------------
        Returns a copy of the nth key of source.
        Use: value = source[i]
        -------------------------------------------------------
        Parameters:
            i - index of the key to access (int)
        Returns:
            value - the i-th key of source (?)
        -------------------------------------------------------
        """
    ...
    def combine(self, source1, source2):
        ...
        while (low1 < len(source1._values)) and (low2 < len(source2._values)):
            print("one")
            if source1._values[low1] < source2._values[low2]:
                temp.append(source1._values[low1])
                source1.pop(0)
            else:
                print("two")
                temp.append(source2._values[low2])
                source2.pop(0)
    ...
    def split(self):
        ...
        while low <= mid:
            target1._values.append(self._values[low])
            low += 1
        else:
            target2._values.append(self._values[low])
            low += 1
        self._values = []
