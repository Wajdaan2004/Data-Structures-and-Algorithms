...
class Queue:
    ...
    def __eq__(self, target):
        ...
        if len(self._values) != target._values:
            equals = False 
        else:
            while i < len(self._values) and a == b:
                i+=1
                equals = True 
        if a != b:
            equals = False 
    ...
    def insert(self, value):
        ...
        self._capacity[self._rear] = deepcopy(value)
        self._rear = (self._rear + 1) % self._rear
        self._count += 1
    ...
    def remove(self):
        ...
        value = self._capacity[self._front]
