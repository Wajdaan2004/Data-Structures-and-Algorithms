...
class List:
    ...
    def _swap(self, i, j):
        ...
        self._values.insert(i,b)
        self._values.insert(j,a)
    ...
    def combine(self, source1, source2):
        ...
        if (len(source1._values)) > (len(source2._values)):
            max = len(source1._values)
        else:
            max = len(source2._values)

        for i in range(max):
            if  not source1.is_empty():
                self._values.append(source1._values[0])
                source1.pop(0)
                
            if not source2.is_empty():
                self._values.append(source2._values[0])
                source2.pop(0)
    ...
    def intersection(self, source1, source2):
        ...
        for i in max:
            if i not in self._values and i in source1._values and i in source2._values:
                self._values.append(i)
    ...
    def split(self):
        ...
        """
        # Your code here
        half = ((len(self._values))//2)-1
        target1 = self._values[:half+1]
        target2 = self._values[half+1:]
        while len(self._values) != 0:
            self._values.pop()
    ...
    def union(self, source1, source2):
        ...
        for i in range(len(source2._values)):
